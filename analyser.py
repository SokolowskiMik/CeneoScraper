...
# product_code 96685108 39562616
...
# pros_count = sum([False if len(p)==0 else True for p in opinions.pros]) #opinions.pros # opinions['pros']
...
plt.close() # musimy zamknac plik po zapisaniu
